...
pub mod prelude {
    ...
    pub use crate::commands::container::ContainerPromoteSubCmdArgs;
    pub use crate::commands::container::ContainerPullSubCmdArgs;
    pub use crate::commands::container::ContainerPushSubCmdArgs;
    pub use crate::commands::container::ContainerRollbackSubCmdArgs;
    pub use crate::commands::container::ContainerRolloutSubCmdArgs;
